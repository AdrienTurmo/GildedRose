...
public class GildedRoseTest {
    ...
    @Test
    public void conjured_item_quality_sould_decrease_twice_as_fast() throws Exception {
        Item conjuredSword = new Item("Conjured sword", 4, 10);
        Item conjuredVest = new Item("Conjured vest", 0, 8);
        Item[] items = new Item[]{conjuredSword,conjuredVest};
        GildedRose app = new GildedRose(items);

        app.updateQuality();

        assertThat(conjuredSword.toString()).isEqualTo("Conjured sword, 3, 8");
        assertThat(conjuredVest.toString()).isEqualTo("Conjured vest, -1, 4");
    }
}